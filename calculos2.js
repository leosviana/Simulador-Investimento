...
function armazenaValoresEntrada(){
    ...
    const tempoRentabilidade = document.getElementById('tempo-rentabilidade').value = sessionStorage("tempo-rentabilidade");
    var taxaInflacao = parseFloat(document.getElementById("taxa-inflacao").value = sessionStorage("taxa-inflacao")) || 0;
    var periodoInvestimento = parseInt(document.getElementById("periodo-investimento").value) || 0;
    var tempoInvestimento = document.getElementById("tempo-investimento").value = sessionStorage("tempo-investimento") || 0;
